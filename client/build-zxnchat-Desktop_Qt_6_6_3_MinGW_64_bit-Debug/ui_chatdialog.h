...
public:
    ...
    FriendInfoPage *friends_info_page;
    ...
    void setupUi(QDialog *ChatDialog)
    {
        ...
        friends_info_page = new FriendInfoPage();
        friends_info_page->setObjectName("friends_info_page");
        stackedWidget->addWidget(friends_info_page);
