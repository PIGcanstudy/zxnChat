...
public:
    ...
    void setupUi(QWidget *ChatUserWid)
    {
        ...
        time_lb->setGeometry(QRect(-10, 20, 69, 19));
    ...
    void retranslateUi(QWidget *ChatUserWid)
    {
        ...
        user_name_lb->setText(QCoreApplication::translate("ChatUserWid", "PigCanStudy", nullptr));
        user_chat_lb->setText(QCoreApplication::translate("ChatUserWid", "\346\242\243", nullptr));
